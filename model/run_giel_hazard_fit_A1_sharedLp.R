## GIEL sensitivity refit, Track A1 (age-based VBGF, IPCA-only) + shared IP2
...
OUT_FILE   <- "data/BWRobustDesign_MCMC_giel_A1_sharedLp.RData"
TRACE_FILE <- "model/BWRobustDesign_traceplots_giel_A1_sharedLp.pdf"
